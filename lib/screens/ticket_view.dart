...
import 'package:my_first_flutter_app/widgets/layout_builder_widgets.dart';
import 'package:my_first_flutter_app/widgets/thick_container.dart';
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text('flying-time', style:isColor==null? Styles.headLineStyle4.copyWith(color: Colors.white):Styles.headLineStyle4,),
                      SizedBox(
            ...
            /*Showing the bottom part of the orange part of the card/ticket*/
            Container(
              decoration:  BoxDecoration(

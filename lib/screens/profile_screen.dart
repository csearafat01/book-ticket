    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          Text("Accomulated miles", style: Styles.headLineStyle2,),
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    AppColumnLayout(firstText: "McDoanal", secondText: "Received from", alignment: CrossAxisAlignment.end, isColor:false,),
                  ],
                ),
                Gap(AppLayout.getHeight(12)),
                const AppLayoutBuilderWidget(section: 12, isColor:false),
